...
We have implemented this work into \texttt{QMCPy}\footnote{\url{https://qmcsoftware.github.io/QMCSoftware/}} version 2.0 \AGSNote{MAKE RELEASE BEFORE RESUBMITTING}, installable with \texttt{pip install -U qmcpy}. The architecture and philosophy underlying \texttt{QMCPy} are described in \citep{choi.QMC_software,choi.challenges_great_qmc_software}. To follow along with code snippets presented in this article, please import \texttt{QMCPy} and \texttt{NumPy} \citep{NumPy.software} via
...
\noindent These code snippets and code producing the plots in this article are available in notebook form\footnote{\url{https://github.com/QMCSoftware/QMCSoftware/blob/master/demos/ld_randomizations_and_higher_order_nets.ipynb}} \AGSNote{Update URL to point to docs at qmcsoftware.github.io}.  
