...
\begin{itemize}
    ...
    \fixed
    \item page 5, middle: At this point, it is not clear yet what “natural order” means. Please explain or at least say this will be explained later.
    ...
    \item page 17, line 9 in Section 6: then -> than; line 10 “as we show” and not “as we shown”
    \fixed 
    \item page 17, last line: bold capital X is not defined in (1) so this statement is confusing.
    ...
    \item references: unusual to have complete first names. Does not seem to be the required format of the journal.
    \response{I am using the provided ACM template. Some articles in the most recent ACM TOMS issue seem to use full first names and some are abbreviated.}
    \response{\url{https://dl.acm.org/toc/toms/current}} 
\end{itemize}
